...
function onKeyDown(e) {
	if (state == GameConstants.STATE_INTRO) {
		if (e.keyCode == 83) gameScreen.highlightMe("Start",true);
		else if (e.keyCode == 67) gameScreen.highlightMe("Credits",true);
		else if (e.keyCode == 73) gameScreen.highlightMe("Instructions",true);
	} else if (state == GameConstants.STATE_PLAYING) {
		if (e.keyCode == 40) downKey = true;
		else if (e.keyCode == 38) upKey = true;
		else if (e.keyCode == 32) redPlane.spaceMe();
		else if ((e.keyCode == 66) && (redPlane.state != PlaneState.LANDED)) redPlane.bombMe();
        else if ((e.keyCode == 66) && (redFactory.menuShowing)) redFactory.highlightMe("RedBomb");
        else if ((e.keyCode == 37) || (e.keyCode == 39) && (redPlane.state != PlaneState.LANDED)) redPlane.flipMe();
        else if ((e.keyCode == 37) || (e.keyCode == 39) && (redFactory.menuShowing)) redFactory.highlightMe("RedJeep");
		else if ((e.keyCode == 49) || (e.keyCode == 97)) redFactory.highlightMe("RedTank");
		else if ((e.keyCode == 50) || (e.keyCode == 98)) redFactory.highlightMe("RedJeep");
		else if ((e.keyCode == 51) || (e.keyCode == 99)) redFactory.highlightMe("RedBomb");
	}
...
function onKeyUp(e) {
	if (state == GameConstants.STATE_INTRO) {
		...
		else if ((e.keyCode == 49) || (e.keyCode == 97)) redFactory.produce("RedTank");
		else if ((e.keyCode == 50) || (e.keyCode == 98)) redFactory.produce("RedJeep");
		else if ((e.keyCode == 51) || (e.keyCode == 99)) redFactory.produce("RedBomb");
        else if ((e.keyCode == 66) && (redFactory.menuShowing)) redFactory.produce("RedBomb");
        else if ((e.keyCode == 37) || (e.keyCode == 39) && (redFactory.menuShowing)) redFactory.produce("RedJeep");
